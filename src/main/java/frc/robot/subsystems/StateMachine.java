...
public class StateMachine extends SubsystemBase {
    ...
    private GraphCommandNode cancelled;
        ...
        safeCoralTravel = m_graphCommand.new GraphCommandNode(
            ...
            setCurrentDriveStateCommand(DriveState.ReefRelative), //fix later
        ...
        public void reachedElevManiGoal() {
           ...
           System.out.println("Reached Elevator/Manipulator Goal:");
        }
        ...
        public void driveStateMachine(){
            ...
            case ProcessorRelative:
                    currentDriveCommand = new SafeTravel(diff, elevator, this);//new ProcessorRelativeDrive(this, drive, pose, driverController);
                    reachedDriveGoal();
                break;
            case CoralStation:
        ...
        public void elevManiStateMachine(){
            ...
            case StartPosition:
                 currentElevManiCommand = new SafeTravel(diff, elevator, this);
            ...
            case SafeCoralTravel:
                    ...
                    //If robot is at safe coral travel and doesnt have coral, it should go to intake positioncurr
                    currentElevManiCommand = new SafeTravel(diff, elevator, this);

                    //will set robot to intake by default if it doesn   t have coral
        ...
        public void periodic() {
            ...
            if(DriverStation.isEnabled()){
                ...
                if (olfElevManiCommand != currentElevManiCommand && currentElevManiCommand != null) {
                    System.out.println("Switching Elevator/Manipulator Command");
                 safeSwitch(olfElevManiCommand, currentElevManiCommand).schedule();
